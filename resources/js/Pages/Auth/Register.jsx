...
export default function Register() {
    ...
    return (
        ...
        <div className="bg-white dark:bg-gray-900">
            ...
            <div className="hidden bg-cover lg:block lg:w-2/4" style={{ background: "url(/assets/images/mobil.jpg)", marginTop: "-120px" }}>
    <div className="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
        <div>
            <h2 className="text-5xl text-center font-bold text-white">Racing School</h2>
            <h6 className="max-w-xl mt-5 font-bold text-gray-300">"Kembangkan Keterampilan Mengemudi Anda di Sekolah Racing Terbaik. Daftar Sekarang dan Siap-siap Melaju ke Puncak Prestasi!"

"Menghadirkan Pelatihan Racing Terbaik untuk Menyulut Api Juara dalam Diri Anda. Bergabunglah dan Rasakan Sensasi Kecepatan!"

"Sekolah Racing Kami Bukan Hanya Tempat Belajar, Tetapi Arena Untuk Membentuk Pemenang Sejati. Segera Bergabung dan Mulailah Petualanganmu!"</h6>
        </div>
    </div>
</div>
                ...
                <div className="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/2">
                    <div className="flex-1">
                        <div className="text-center">
                            <div className="overflow-clip items-center flex justify-center w-full px-3 py-0"><img src="/assets/images/logos/bendera.png" className="w-52" alt="" /></div>
